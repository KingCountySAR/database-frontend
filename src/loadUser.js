// Forked loadUser.js to dispatch loadingUser actions
import { loadingUser, userFound, userExpired, loadUserError } from 'redux-oidc';
...
export function getUserCallback(user) {
    if (user && !user.expired) {
        ...
        reduxStore.dispatch(userFound(null)); // Sets loadingUser to false
    }
    return user;
}
